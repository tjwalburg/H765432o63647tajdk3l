...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	<ul class="nav navbar-nav">
		...
		<li class="active"><a href="rooms" id="rooms" onclick="javascript:cambiarClase">Habitaciones</a></li>
		...
		<div class="container">
			<div class="single-top">
				<div class="col-md-6 single-left">
					<a href="detalle"><img src="images/14.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-md-6 single-right">
					<h3><a href="detalle">Publishing software like Aldus</a></h3>
			...
			<div class="single-top">
				<div class="col-md-6 single-right">
					<h3><a href="detalle">There are many variations</a></h3>
					<p>The point of using Lorem Ipsum is that it has a <strong>more-or-less normal</strong> distribution of letters, as opposed to using 'Content here, content here'</p>
					<p>when an unknown printer took a s that it has galley of type and scrambled it to make a type </p>
					<h5>*The Booking detials for must be Ipsum is that it has.</h5>
					<h6>• Our stylish hotel is ideally located</h6>
				...
				<div class="col-md-6 single-left">
					<a href="detalle"><img src="images/15.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="single-top">
				<div class="col-md-6 single-left">
					<a href="detalle"><img src="images/13.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-md-6 single-right">
					<h3><a href="detalle">Lorem Ipsum is that it has</a></h3>
					<p>The point of using Lorem Ipsum is that it has a <strong>more-or-less normal</strong> distribution of letters, as opposed to using 'Content here, content here'</p>
					<p>when an unknown printer took a s that it has galley of type and scrambled it to make a type </p>
					<h5>*The Booking detials for must be Ipsum is that it has.</h5>
					<h6>• Our stylish hotel is ideally located</h6>
